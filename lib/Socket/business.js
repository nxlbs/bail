...
const makeBusinessSocket = (config) => {
    ...
    const productUpdate = async (productId, update) => {
        ...
        const productCatalogEditNode = generic_utils_1.getBinaryNodeChild(
            result,
    ...
    const productCreate = async (create) => {
        ...
        const productCatalogAddNode = generic_utils_1.getBinaryNodeChild(
            result,
            'product_catalog_add',
        );
    ...
    const productDelete = async (productIds) => {
        ...
        const productCatalogDelNode = generic_utils_1.getBinaryNodeChild(
            result,
