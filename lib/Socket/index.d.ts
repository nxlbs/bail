...
declare const makeWASocket: (config: UserFacingSocketConfig) => {
  ...
  sendAlbumMessage: (
    jid: string,
    medias: import("../Types").WAProto.IMessage,
  ...
  updateCallPrivacy: (
    value: import("../Types").WAPrivacyCallValue,
  ) => Promise<void>;
  ...
  updateGroupsAddPrivacy: (
    value: import("../Types").WAPrivacyGroupAddValue,
  ) => Promise<void>;
  ...
  addLabel: (
    jid: string,
    labels: import("../Types/Label").LabelActionBody,
  ) => Promise<void>;
