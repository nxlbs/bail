...
const configureSuccessfulPairing = (
    ...
    const bizName =
        businessNode === null || businessNode === void 0 ? void 0 : businessNode.attrs.name;
    ...
    const isHostedAccount =
        accountType !== undefined && accountType === WAProto_1.proto.ADVEncryptionType.HOSTED;
    ...
    const authUpdate = {
        ...
        platform:
            platformNode === null || platformNode === void 0 ? void 0 : platformNode.attrs.name,
    };
    return {
        creds: authUpdate,
        reply,
...
const encodeSignedDeviceIdentity = (account, includeSignatureKey) => {
    ...
    if (
        !includeSignatureKey ||
        !((_a = account.accountSignatureKey) === null || _a === void 0 ? void 0 : _a.length)
    ) {
