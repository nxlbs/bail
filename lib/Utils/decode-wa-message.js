...
function decodeMessageNode(stanza, meId, meLid) {
    ...
    const senderPn =
        (_a = stanza === null || stanza === void 0 ? void 0 : stanza.attrs) === null ||
        _a === void 0
            ? void 0
            : _a.sender_pnAdd;
    const senderLid =
        (_b = stanza === null || stanza === void 0 ? void 0 : stanza.attrs) === null ||
        _b === void 0
            ? void 0
            : _b.sender_lid;
    const participant = stanza.attrs.participant;
    const participantLid =
        (_c = stanza === null || stanza === void 0 ? void 0 : stanza.attrs) === null ||
        _c === void 0
            ? void 0
            : _c.participant_lid;
    ...
    const pushname =
        (_d = stanza === null || stanza === void 0 ? void 0 : stanza.attrs) === null ||
        _d === void 0
            ? void 0
            : _d.notify;
    const key = {
    ...
    if (msgType === 'newsletter') {
        fullMessage.newsletterServerId = +((_f = stanza.attrs) === null || _f === void 0
            ? void 0
            : _f.server_id);
    }
    if (key.fromMe) {
